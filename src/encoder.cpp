...
int main(int argc, char **argv)
{
	...
	serial::Serial my_serial("/dev/serial/by-id/usb-Arduino__www.arduino.cc__Arduino_Uno_75439333335351412220-if00", 9600, serial::Timeout::simpleTimeout(1000));
  	...
  	else
	{
 	...
 	while (ros::ok())
 	{
    		std_msgs::String msg;
    		std::string result; 
   	 	size_t len  = my_serial.readline(result);  
